...
<body>
	...
	<nav class="navbar navbar-inverse">
		<div class="container">
			<div class="navbar-header">
				<a class="navbar-brand" href="/newPage">MultifunctionalScanner</a>
			</div>
	...
	<div class="container">
		...
		<form:form class="form-horizontal" method="post" modelAttribute="database" action="/">
		...
		<spring:bind path="host">
			...
			<button href="/newPage"type="submit">ADD
			</button>
		</form:form>
	</div>
